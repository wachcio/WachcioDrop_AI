  ...
  return (
    <div className="flex flex-col gap-4 max-w-lg mx-auto">
      ...
      <div className="bg-green-800 rounded-2xl p-6 text-white flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-green-300 text-sm">Inteligentny sterownik nawadniania</p>
        {info && (
      ...
      {error ? (
        ...
        <>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            ...
            <Row icon={CalendarDays} label="Data kompilacji"  value={`${info.build_date} ${info.build_time}`} />
          </div>
